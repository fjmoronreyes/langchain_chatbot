...
class ChromaVectorDB:
    def __init__(self, embedding_model: CustomEmbeddings, folder_path: str,
    ...
    def _load_vectorstore(self) -> Chroma:
        ...
        return Chroma(persist_directory=self.chroma_path,
    ...
    def create_db(self, folder_path: str):
        ...
        self.vectorstore = Chroma.from_texts(
            texts=texts, embedding=self.embedding_model,
            persist_directory=self.chroma_path
        )
        logger.info(f"VectorDB Chroma persisted in {self.chroma_path}.")
...
if __name__ == "__main__":
    ...
    query = "Release date Stellar blade PS5"
