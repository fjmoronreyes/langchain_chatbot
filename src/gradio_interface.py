...
def chat_with_bot(user_input):
    ...
    human_history = "\n".join([msg.content for msg in chat_history.messages if isinstance(msg, HumanMessage)])
    ai_history = "\n".join([msg.content for msg in chat_history.messages if isinstance(msg, AIMessage)])
...
gr.Interface(fn=chat_with_bot, inputs=inputs, outputs=outputs, title="Chat with AI").launch()
